...
bool TutorialApplication::processUnbufferedInput(const Ogre::FrameEvent& fe)
{
	...
	{
		Ogre::LogManager::getSingletonPtr()->logMessage("Left Mouse Button Pressed!");
	...
	// A side effect: the light will slowly turn off and on if you continually hold the right mouse button.
	...
	if (mKeyboard->isKeyDown(OIS::KC_U)) dirVec.y += move;
	if (mKeyboard->isKeyDown(OIS::KC_O)) dirVec.y -= move;
